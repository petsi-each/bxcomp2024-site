        ...
        <div className="mb-20 grid grid-cols-1 gap-y-8">
            {
                props.desafios.map((desafio) => (
                    <article className="p-2 px-14 max-w-[600px] min-h-32 h-fit bg-[#FF9C46] rounded-full text-center text-pretoBX hover:ring-8 hover:ring-azulBX hover:ring-opacity-20">
