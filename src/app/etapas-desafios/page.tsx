                             ...
                             {/*procurar por uma forma mais concisa de usar hover,etc */}
                                {
                                    etapa.estado == false ?
                                        ...
                                        :
                                        <div>
                                            <ImageG className="-z-10 rounded-3xl" src={etapa.icon} alt={etapa.altIcon} fill={true} />
                                            <h2 className="mt-28 font-poppins text-white text-2xl drop-shadow-lg"><b>Etapa {etapa.etapaIndice}</b></h2> {/*TODO: o texto está sendo renderizado por baixo da imagem*/}
                                            <h3 className="-mt-1 font-poppins text-white text-base drop-shadow-lg">{etapa.tema}</h3>
                                        </div>
                                }
                            </button>
                        ))
