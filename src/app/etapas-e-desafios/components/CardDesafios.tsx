        ...
        <div className="grid grid-cols-1 gap-y-5">
            {
                props.desafios.map((desafio, idx) => (
                    <article key={idx} className="px-16 py-2 max-w-[600px] min-h-32 h-fit bg-[#FF9C46] rounded-full text-center text-pretoBX hover:transition-all hover:duration-150 hover:ring-8 hover:ring-azulBX hover:ring-opacity-20">
                        <h2 className="text-2xl">{desafio.desafio}</h2>
