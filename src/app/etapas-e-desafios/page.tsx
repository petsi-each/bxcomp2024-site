...
export default function EtapasDesafios() {
    ...
    return (
        <main>
            <h1 className="mx-16 sm:mx-28 md:mx-36 lg:mx-48 xl:mx-60 mt-12 mb-8 text-right text-6xl text-brancoBX"> Etapas <br></br> <span className="text-laranjaBX">&</span> Desafios</h1> 
