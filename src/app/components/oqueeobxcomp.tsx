...
export default function oqueeobxcomp() {
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[pretoBX]">
            {/* Background Image Container */}
            <div className="absolute inset-0 z-0 flex items-center justify-center">
                <ImageG src="/home/sobrebx.png" alt="Logo do BXComp" quality={100} width={1154} height={875} className="object-contain"/>
            </div>

            {/* Text Balloon */}
            <div className="relative z-10 w-full max-w-sm md:max-w-2xl p-8 md:p-16 lg:p-24 bg-brancoBX bg-opacity-90 rounded-[50px] md:rounded-[100px] lg:rounded-[125px] shadow-lg text-center flex flex-col items-center mx-4">
                <h2 className="text-2xl md:text-3xl lg:text-4xl text-laranjaBX mb-4">O que é BXCOMP?</h2>
                <p className={`${poppins.className} text-sm md:text-base lg:text-lg text-black mb-6 font-pop text-left`}>
