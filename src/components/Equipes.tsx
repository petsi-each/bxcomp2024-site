...
export default function Equipes(){
    return (
    <section className="bg-brancoBX flex flex-row justify-center">
        ...
        <section className="flex flex-col items-center justify-center">
            ...
            <div className="bg-laranjaBX w-80 h-36 rounded-tl-[96px] rounded-br-[96px] flex flex-row items-center justify-center">
                <h3> Nome equipe </h3>
